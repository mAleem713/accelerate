...
Backup site, restore or migrate it wherever you need it. Backup to Dropbox, Google Drive, Amazon, FTP to restore or migrate WordPress.
...
<li>Manage backups - delete backups, view backups or restore logs</li>
...
<li>Upload to SFTP, FTP, Dropbox, Google Drive & Amazon S3</li>
<li>Import from SFTP, FTP, Dropbox, Google Drive & Amazon S3</li>
...
<li>Backups cloud path - specify a custom cloud path where your site backups should be stored</li>
